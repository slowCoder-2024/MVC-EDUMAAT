      ...
      <div class="loader"  style="display: none"></div>
            ...
            <div id="ListDiv" style="display:block;">
               <div class="form-group">
                  <button type="button" class="btn btn-primary btn-custom waves-effect waves-light col-md-3" onclick="showDiv()">Raise New Complaint</button>
               </div>
                <div class="x_title">
                     <div class="clearfix">
                     </div>
               ...
               <br>
                <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>View Pending Complaint(s)</b></h4>
                              <br>
                              ...
                              <tbody id="complaintManagementLists">
                              		<c:if test="${!empty complaintManagementLists}">
                                      <c:forEach items="${complaintManagementLists}" var="complaintManagement">
                                      		<tr >
                                      		 <td>${complaintManagement.getAcademicYear().getAcademicYearTitle()}</td>
		                                  	 <td><fmt:formatDate pattern="dd/MM/yyyy" value="${complaintManagement.getCreatedDate()}" /></td>
		                                    <td>${complaintManagement.getComplaintReason()}</td>
		                                   <c:if test="${complaintManagement.getComplaintStatus()=='Pending'}">
		                                    ...
		                                    <td>
		                                    	<a href="#" id="complaintCancel"  type="button" data-href="#" data-id="${complaintManagement.getComplaintId()}" data-toggle="modal" data-target="#complaintCancelConfirmation">
               ...
               <br />
                        ...
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Complaint Status</b></h4>
                               <table data-toggle="table"
                                 data-show-columns="true"
                                 data-page-list="[5, 10, 20]"
                                 data-page-size="5"
                              ...
                              <tbody id="complaintApprovedOrRejectedLists">
                              	<c:if test="${!empty complaintApprovedOrRejectedLists}">
                                      <c:forEach items="${complaintApprovedOrRejectedLists}" var="complaintApprovedOrRejectedList">
                                      		<tr >
                                      		 <td>${complaintApprovedOrRejectedList.getAcademicYear().getAcademicYearTitle()}</td>
		                                  	 <td><fmt:formatDate pattern="dd/MM/yyyy" value="${complaintApprovedOrRejectedList.getCreatedDate()}" /></td>
		                                    <td>${complaintApprovedOrRejectedList.getComplaintReason()}</td>
		                                       <c:if test="${complaintApprovedOrRejectedList.getComplaintStatus()=='Resolved'}">
		                                    		<td ><span class="label label-table label-success">
		                                              ${complaintApprovedOrRejectedList.getComplaintStatus()}
		                                              </span>
		                                    </td>
		                                    </c:if>
		                                  <c:if test="${complaintApprovedOrRejectedList.getComplaintStatus()=='Rejected'}">
		                                    		<td ><span class="label label-table label-danger">
		                                              ${complaintApprovedOrRejectedList.getComplaintStatus()}
		                                              </span>
		                                    </td>
		                                    </c:if>
		                                    <td>${complaintApprovedOrRejectedList.getActionTaken()}</td>
		                                    <td>${complaintApprovedOrRejectedList.getComplaintReceiver().getEmail()}</td>
             ...
             <div class="modal fade" id="complaintCancelConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
		               <div class="modal-dialog" role="document">
		                  <div class="modal-content">
		                     ...
		                     <div class="modal-body">
		                        <h5>Are you sure you want to cancel your complaint?</h5>
		                     </div>
		                     <div class="modal-footer">
		                       <form id="cancelcomplaintform" action="${pageContext.request.contextPath}/complaintManagement/cancel" method="post">
                              <input type="hidden" id="complaintId" name="complaintId">
                                 <button type="button" id="complaintCancelConfirm" class="btn btn-primary" data-dismiss="modal">Yes</button>
		                   </form>
		                     </div>
		                  </div>
		               </div>
             ...
             <div class="modal fade" id="addComplaintConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                     ...
                     <div class="modal-body">
                        <h5>Are you sure to raise a complaint?</h5>
                     </div>
                     <div class="modal-footer">
                        <button type="button" id="addComplaintConfirm" class="btn btn-primary" data-dismiss="modal">Yes</button>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-primary">
                              <div class="panel-heading">
                                  <h4 class="panel-title"><b>New Complaint</b></h4>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                       <form class="form-horizontal" id="addComplaintForm" action="${pageContext.request.contextPath}/complaintManagement/complaintRequest" method="post">
                      
                           <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Complaint Description<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="complaintReason" class="form-control" id="complaintReason" placeholder="" required="required">
                                 </div>
                              </div>
                                <div class="row">
                                 ...
                                 <div class="col-sm-offset-3">
                                    ...
                                    <button style="float:right"  type="button" id="addComplaint" class="btn btn-success btn-custom waves-effect waves-light">Complaint</button>
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
       ...
       <script src="${pageContext.request.contextPath}/resources/themes/script/complaintrequester.js" type="text/javascript"></script>
     <script type="text/javascript">
