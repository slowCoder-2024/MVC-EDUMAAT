...
<div class="container">
      <div class="loader"  style="display: none"></div>
              ...
              <%--  	<security:authorize access="hasRole('section/add')"> --%>
                     ...
                     <button type="button" class="btn btn-primary col-md-3 btn-custom waves-effect waves-light" onclick="showDiv()">Add New Asset</button>
                  </div>
                  <div class="x_title">
                     <div class="clearfix">
                     </div>
              ...
              <%--  	<security:authorize access="hasRole('section/viewlist')"> --%>
                        ...
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Manage Asset</b></h4>
             ...
             <%--   	</security:authorize> --%>
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              ...
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="addAssetItemform" action="${pageContext.request.contextPath}/asset/manageasset/register" method="post">
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Asset Name <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="assetName" class="form-control" id="assetName" placeholder="" required maxlength="50">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Asset Type <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                     <select name="assetTypeId" id="assetTypeId" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                                      <option value="" disabled selected>Select Asset Type </option>
                                      <c:if test="${!empty assetTypeList}">
                                           <c:forEach items="${assetTypeList}" var="assetTypeList">
                                           <option value="${assetTypeList.getAssetTypeId()}">${assetTypeList.getAssetType()}</option>
                                          </c:forEach>
                                       </c:if>
                               ...
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Asset Category <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                     <select name="assetCategoryId" id="assetCategoryId" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                                      <option value="" disabled selected>Select Asset Category </option>
                                      <c:if test="${!empty assetCategoryList}">
                                           <c:forEach items="${assetCategoryList}" var="assetCategoryList">
                                             <option value="${assetCategoryList.getAssetCategoryId()}">${assetCategoryList.getAssetCategoryName()}</option>
                                          </c:forEach>
                                       </c:if>
                              ...
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Manufacturer</label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="manufacturer" class="form-control" id="manufacturer" placeholder=""  maxlength="50">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Model Number </label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="modelNumber" class="form-control" id="modelNumber" placeholder="" maxlength="50">
                                 </div>
                              </div>
               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Serial Number</label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="serialNumber" class="form-control" id="serialNumber" placeholder=""  maxlength="50">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Type</label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="type" class="form-control" id="type" placeholder="" maxlength="50">
                                 </div>
                              </div>
			
				<div class="form-group" id="saleratediv">
                                 <label for="" class="col-sm-3 control-label">Price <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                  <input type="text" name="price" class="form-control" id="price" placeholder="" required="required" onkeypress="return decimalAmount(this, event, 2)"  maxlength="50">
                                  </div>
                              </div>
                                 ...
                                 <div class="col-sm-7"> 
                                  <input type="text" name="quantity" class="form-control" id="quantity" placeholder="" required="required" onkeypress="return decimalAmount(this, event, 2)"  maxlength="50">
                                  </div>
                              </div>
				 			...
				 			<div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-sm-7"> 
                                  ...
                                  <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Asset Description</label> 
                                 <div class="col-sm-7"> 
                                    <textarea  class="form-control" id="assetDescription" name="assetDescription"></textarea>                                 </div>
                              </div>
                               <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="col-sm-7"> 
                                 	 <select name="assetStatus" id="assetStatus" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required"><option value="" disabled selected>Select Status</option><option value="0">Active</option><option value="1">Inactive</option><option value="2">Renewal</option></select>
								  </div>
                              </div>
	                              	<div class="row">
	                                 <span style="float:left;margin-top:0px;"class="at-required-highlight">Mandatory fields are marked with an asterisk (*)</span>
	                                 <div class="col-sm-offset-3">
	                                    <button style="float:right"  type="button" id="saveassetitem" class="btn btn-success btn-custom waves-effect waves-light">Asset Register</button>
               ...
               <div class="modal fade" id="assetitemsaveconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                           ...
                           <div class="modal-body">
                              <h5>Are you sure you want to add this Asset ?</h5>
                           </div>
                           <div class="modal-footer">
                              <button type="button" id="assetitemsaveconfirm" class="btn btn-primary" data-dismiss="modal">Yes</button>
                           </div>
                        </div>
                     </div>
                  </div>
               <div id="EditFormDiv" style="display:none;" >
                        ...
                        <div class="col-lg-12">
                           ...
                           <form class="form-horizontal" id="updateinventoryitemform" action="${pageContext.request.contextPath}/inventoryandpurchase/item/update" method="post">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                     <select name="editTaxClassId" id="editTaxClassId" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                                      ...
                                      <c:if test="${!empty taxClassList}">
                                           <c:forEach items="${taxClassList}" var="taxClassList">
                                             <option value="${taxClassList.getTaxId()}">${taxClassList.getTaxTypeName()}</option>
                                          </c:forEach>
                                       </c:if>
                               ...
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Quantity<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="editQuantity" class="form-control" id="editQuantity" placeholder="" onkeypress="return isNumber(event)" required maxlength="50">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Location<span class="at-required-highlight">*</span></label> 
				...
				<div class="form-group" id="editpurchaseratediv">
                                 <label for="" class="col-sm-3 control-label">Purchase Rate<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                  <input type="text" name="editpurchaserate" class="form-control" id="editpurchaserate" placeholder="" required="required" onkeypress="return decimalAmount(this, event, 2)"  maxlength="50">
                                  </div>
                              </div>
				<div class="form-group">
				...
				<div class="form-group">
                                   <label for="" class="col-sm-3 control-label">Fixed Asset? <span class="at-required-highlight">*</span></label> 
   ...
   <script src="${pageContext.request.contextPath}/resources/themes/assets/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
    ...
    <%--   <script src="${pageContext.request.contextPath}/resources/themes/assets/plugins/select2/js/select2.min.js" type="text/javascript"></script> --%>
     <%--  <script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/assets/pages/autocomplete.js"></script> --%>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/asset.js" type="text/javascript"></script>
