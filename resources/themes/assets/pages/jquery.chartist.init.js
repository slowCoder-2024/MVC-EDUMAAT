...
function classData()
{
	...
	var $areaData4 = [];
	  $.ajax({
		   url:ctx+'/dashboard/studentRadioFromClassByInstitution',
		   type:'GET',
		    async: false,
	        cache: false,
		   success: function(response){
		  	...
		  	$.each(response, function(key,data)
                         {   
         			 //creating area chart
		  	$areaData1.push(data.f4);
		  	$areaData2.push(data.f1);
		  	$areaData3.push(data.f2);
		  	$areaData4.push(data.f3);
         		   });
...
/*function todayStudentAttendanceByClass(){
	var $areaData1 = [];
	var $areaData2 = [];
	var $areaData3 = [];
	var $areaData4 = [];
      ...
      dataType:  'json',
       success: function(response){
			$.each(response, function(key,data)
                    {   
    			 //creating area chart
				$areaData1.push(data.f1);
			  	$areaData2.push(data.f2);
			  	$areaData3.push(data.f3);
			  	$areaData4.push(data.f4);
    		   });
