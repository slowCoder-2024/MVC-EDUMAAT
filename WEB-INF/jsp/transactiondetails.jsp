...
<html>
   ...
   <body class="fixed-left">
                           ...
                           <div class="card-box" style="height: 250px">
                            ...
                            Transaction Management
                              ...
                              <div class="col-lg-4 col-sm-6">
                                <div class="widget-panel widget-style-2 bg-white" onclick="checkSMSCount();" >
                                    <i class="md  md-mode-edit text-primary"></i>
                                    <h4 class="m-0 text-dark counter font-600">SMS</h4>
                                    <div class="text-muted m-t-5">View Balance Message Count</div>
                                  
                                </div>
                            </div>
                           <!--  <div class="col-lg-4 col-sm-6">
                                <div class="widget-panel widget-style-2 bg-white" onclick="" >
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/transactiondetails.js"></script>
      <script type="text/javascript">
