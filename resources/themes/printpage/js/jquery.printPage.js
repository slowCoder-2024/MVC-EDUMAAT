...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    var components = {
      iframe: function(url){
        return '<iframe id="printPage" name="printPage" src='+url+' style="position:absolute;top:0px; left:0px;width:0px; height:0px;border:0px;overfow:none; z-index:-1;a[href]:after {content: none !important;}"></iframe>';
      },
