         ...
         <div id="ListDiv" style="display:block;">
                  ...
                  <div class="col-lg-4 col-sm-6">
                                <div class="widget-panel widget-style-2 bg-white" onclick="showmodulewiseattendance();">
                                    <i class="ion ion-android-promotion  text-primary"></i>
       ...
       <div id="OpenModuleAttendanceDiv" style="display:none;">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">View Module Attendance Percentage For Student</h2>
                              </div>
                           ...
                           <form class="form-horizontal" id="moduleattendanceform">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                          <select name="moduleId" id="moduleId" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-offset-3">
                                    <button style="float:right" type="button" id="getModuleAttendanceDetails"  class="btn btn-success btn-custom waves-effect waves-light">Get Details</button>
        ...
        <div id="OpenOverAllDiv" style="display:none;">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">View OverAll Attendance Percentage For Student</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="overallattendanceform">
                            <div class="form-group">
                              ...
                              <div class="row">
                                 <span style="float:left;margin-top:0px;"class="at-required-highlight">Mandatory fields are marked with an asterisk (*)</span>
                                 <div class="col-sm-offset-3">
                                    <button style="float:right" type="button" id="getOverAllDetails"  class="btn btn-success btn-custom waves-effect waves-light">Get Details</button>
                                    <button style="float:right" type="button" class="btn btn-danger btn-custom waves-effect waves-light" onclick="location.reload(this);">Cancel</button>
                                    </div>
                              </div>
                           </form>
                      ...
                      <div id="overallattendancedetails" style="display:none;">
                        ...
                        <div class="col-sm-12">
                           <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title" style="color:purple;">Attendance Percentage Details</h4>
                      <br>
                                 <table class="table table-striped table-bordered" id="overAllStudentAttendancePercentage">
                              <thead>
                                 <tr>
                                    <th>Admission No</th>
                                   <th>Student Name</th>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/assets/js/jquery.app.js"></script>
       ...
       <script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/assets/plugins/moment/moment.js"></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/assets/pages/jquery.form-pickers.init.js"></script>
         ...
         <script src="${pageContext.request.contextPath}/resources/themes/script/attendancepercentagereport.js"></script>
