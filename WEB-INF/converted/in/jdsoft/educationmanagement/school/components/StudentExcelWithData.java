...
public class StudentExcelWithData
extends AbstractExcelView {
    protected void buildExcelDocument(Map<String, Object> models, HSSFWorkbook workbook, HttpServletRequest arg2, HttpServletResponse arg3) throws Exception {
        ...
        header.createCell(29).setCellValue("House Name*");
        header.getCell(29).setCellStyle((CellStyle)style);
        header.createCell(30).setCellValue("Aadhar Card Number");
        ...
        for (Student student : students) {
            ...
            aRow.createCell(29).setCellValue(student.getHouses().getHouseName());
            if (student.getAadharCardNumber() != null) {
                aRow.createCell(30).setCellValue((double)student.getAadharCardNumber().longValue());
            }
