...
public class TransferCertificateRequisitionException
extends EdumaatException {
    private static final long serialVersionUID = 1L;

    public TransferCertificateRequisitionException(Message message) {
        super(message);
    }

    public TransferCertificateRequisitionException(ComplaintManagementException e, Message message) {
        super(e, message);
    }
}
