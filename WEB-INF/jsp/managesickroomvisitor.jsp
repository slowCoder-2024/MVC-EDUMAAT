...
<div class="container">
      <div class="loader"  style="display: none"></div>
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">SickRoom Visitor Details</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="managesickroomvisitorform">
         ...
         <div class="row" id="academicYearSickRoomVisitorList" style="display:none;">
                        <div class="col-sm-12">
                           <div class="card-box">
                             <!--  <h4 class="m-t-0 header-title" style="color:purple;"><b>SickRoom Visitor Details</b></h4> -->
                              <table class="table table-bordered" id="sickroomvisitorlist">
                              <thead>
                                       <tr>
                                       	<th>Academic Year</th>
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
         ...
         <script src="${pageContext.request.contextPath}/resources/themes/script/managesickroomvisitor.js"></script>
