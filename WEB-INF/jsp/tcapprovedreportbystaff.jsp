...
<div class="container">
      <div class="loader"  style="display: none"></div>
        ...
        <div id="OpenOverAllDiv">
                                <div class="row">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">View Transfer Certificate Applied Student</h2>
                              </div>
                           ...
                           <form class="form-horizontal" id="overallattendanceform">
                            <div class="form-group">
                             ...
                             <div class="form-group-groupcriteria" style="display: block">
                      ...
                      <div id="overallattendancedetails" style="display:none;">
                        ...
                        <div class="col-sm-12">
                           <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title" style="color:purple;">Transfer Certificate Applied Student List</h4>
                      <br>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/assets/js/jquery.app.js"></script>
       ...
       <script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/assets/plugins/moment/moment.js"></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/assets/pages/jquery.form-pickers.init.js"></script>
         ...
         <script src="${pageContext.request.contextPath}/resources/themes/script/tcapprovedreportbystaff.js"></script>
