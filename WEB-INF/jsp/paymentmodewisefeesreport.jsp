                ...
                <div class="form-group">
                              ...
                              <div class="form-group">
                               ...
                               <div class="col-sm-offset-3">
                                 <button style="float:right"  type="button" id="getList" class="btn btn-success btn-custom waves-effect waves-light">Get List</button>
                               </div>
                               </form>
                               </div>
                               </div>
                ...
                <div class="tables">
                  <div class="table-responsive bs-example widget-shadow">
                     <table class="table table-bordered" id="feesTemplateItemList">
                        ...
                        <tbody >
                         <%--   <c:if test="${!empty ledgerAccountHead}">
                              <c:forEach items="${ledgerAccountHead}" var="ledgerAccountHead">
                                 
                              <tr>
                               <td>${ledgerAccountHead.ledgerName}</td>
                              	 <td>${ledgerAccountHead.totalAmount}</td>
                                    <td>${ledgerAccountHead.paidReceiptAmount}</td>
                                    <td>${ledgerAccountHead.discountAmount}</td>
                                    <td>
                                       <a href="#" id="edit"  type="button"data-href="#" data-id="" data-toggle="modal"onclick="showeditclassandsectionDiv()">
                                       <span class="glyphicon glyphicon-credit-card"></span> 
                                       </a>
                                      <!--  <a href="#"  id="delete"  type="button" data-href="#"  data-id="" data-toggle="modal" data-target="#confirm_delete_class">
                                       <span class="glyphicon glyphicon-credit-card"></span> 
                                       </a> -->
                                    </td>
                                 </tr>
...
<script src="${pageContext.request.contextPath}/resources/themes/script/paymentmodewisefeesreport.js"></script>
<script type="text/javascript">
