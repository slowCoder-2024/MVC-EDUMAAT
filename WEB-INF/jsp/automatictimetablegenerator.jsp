...
<div class="container">
      <div class="loader"  style="display: none"></div>
         ...
         <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Automatic Time Table Generator</b></h4>
               ...
               <div id="EditTimeTableGeneratorDiv" style="display:none;">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              ...
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="updateTimeTableGeneratorForm" action="${pageContext.request.contextPath}/timetable/generator/automatic/update" method="post">
 ...
 <script src="${pageContext.request.contextPath}/resources/edumaatalert/edumaatalert.js"></script>
  <script src="${pageContext.request.contextPath}/resources/themes/assets/js/detect.js"></script>
   ...
   <script src="${pageContext.request.contextPath}/resources/themes/assets/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/automatictimetablegenerator.js" type="text/javascript"></script> 
