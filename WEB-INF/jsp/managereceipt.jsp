                              ...
                              <div class="form-group form-group-special-category "style="display: none">
                                ...
                                <div class="row">
                                 <div class="col-sm-offset-3">
                                   <button style="float:right" type="submit"  id="getdetailsfromselectedcriteria" class="btn btn-success btn-custom waves-effect waves-light">Get Receipt</button>
					...
					Delete Individual Receipts
                      ...
                      <div class="tables">
                         <div class="table-responsive bs-example widget-shadow">
                             ...
                             <br>
             <form class="form-horizontal" id="generatereceiptform" method="post" action="${pageContext.request.contextPath}/receipt/receiptDelete">
                  ...
                  <div class="form-group">
                         ...
                         <input id="selectedStudentIds" name="selectedStudentIds" type="hidden"> 
             					 <div class="row">
                                 		<div class="col-sm-offset-3">
                                            <button style="float:right" type="button" id="deletegeneratereceipt" class="btn btn-info btn-custom waves-effect waves-light">Delete Generate Receipt(s)</button>
									   </div>
                              </div>
                        </form> 
                       </div>
