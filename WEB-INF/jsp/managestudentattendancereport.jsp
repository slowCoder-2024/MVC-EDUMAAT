...
<div class="container">
		 <div class="loader"  style="display: none"></div>
             <div id="studentAttendanceDiv" style="display:block;">
                
          <div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Manage Student Attendance Details</h2>
                              </div>
                        ...
                        <form class="form-horizontal" id="studentAttendanceForm" action="${pageContext.request.contextPath}/studentattendance/add" method="post">
                           ...
                           <br/>
                              ...
                              <div id="dateattendancedetails" style="display:none;">
                               <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title" style="color:purple;">Attendance Details</h4>
                      <br>
                                 <table class="table table-striped table-bordered" id="studentsDateAttendanceList">
                              <thead>
                                 <tr>
              ...
              <div class="modal fade" id="updateStudentAttendanceConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                      <form id="updateStudentForm" action="${pageContext.request.contextPath}/studentattendance/managestudentattendancereport/update" method="post">
               ...
               <div class="modal fade" id="bulkConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
											  <form id="deleteStudentAttendanceForm" action="${pageContext.request.contextPath}/studentattendance/managestudentattendancereport/deleteAll" method="post">
...
<script src="${pageContext.request.contextPath}/resources/themes/script/managestudentattendancereport.js" type="text/javascript"></script> 
<script type="text/javascript">
