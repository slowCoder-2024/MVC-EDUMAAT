...
<div class="container">
      <div class="loader"  style="display: none"></div>
                ...
                <div class="row">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Manage Module Attendance Details</h2>
                              </div>
                     ...
                     <div class="tables">
                      ...
                      <!--    <input type="hidden" id="studentAndAttendanceIds" name="studentAndAttendanceIds"> -->
                         ...
                         <div class="row">
                            <div class="col-sm-offset-3">
                            <button style="float:right" type="button" id="getMonthDetails"   class="btn btn-info btn-custom waves-effect waves-light">Get Details</button>
                              <button style="float: right" type="reset" class="btn btn-danger btn-custom waves-effect waves-light" onclick="location.reload()">Cancel</button>
                           ...
                           <div id="editattendancedetails" style="display:none;">
                         ...
                         <input type="hidden" id="studentAndAttendanceIds" name="studentAndAttendanceIds">
                           ...
                           <div class="row">
                              <div class="col-sm-offset-3">
                               ...
                               <button style="float: right" type="button" onclick="showeattendancediv()" class="btn btn-info back btn-custom waves-effect waves-light">Back</button>       
                              </div>
                           </div>
                                </div>
                      </div>
              ...
              <div class="modal fade" id="deleteStudentAttendanceConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                      <form id="deleteStudentForm" action="${pageContext.request.contextPath}/staff/moduleattendance/delete" method="post">
                              <input type="hidden" id="deleteStudentAttendanceId" name="deleteStudentAttendanceId">
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <h5>Are you sure? you want to update this Attendance Record??</h5>
                     </div>
                     <div class="modal-footer">
                      <form id="updateStudentForm" action="${pageContext.request.contextPath}/staff/moduleattendance/update" method="post">
                              <input type="hidden" id="updateStudentAttendanceId" name="updateStudentAttendanceId">
                              <button type="button" id="confirmUpdateStudent"  class="btn btn-primary" data-dismiss="modal">Yes</button>
                           </form>
                           </div>
                  </div>
               </div>
               ...
               <div class="modal fade" id="bulkConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										 <h5>Are you sure? You want to delete this Attendance Details ?? </h5>
									</div>
									<div class="modal-footer">
											  <form id="deleteStudentAttendanceForm" action="${pageContext.request.contextPath}/staff/moduleattendance/deleteAll" method="post">
                             <input id="selectedStudentAttendanceIds" name="selectedStudentAttendanceIds" type="hidden">
                   ...
                   <div id="monthattendancedetails" style="display:none;">
                               <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box table-responsive">
                             <h4 class="m-t-0 header-title" style="color:purple;">Attendance Details</h4>
                      <br>
                              ...
                              <tbody >
                               ...
                               <br>
                                 <div class="row">
                                 <div class="col-sm-offset-3">
                                   <button style="float:right" type="button" id="deleteStudents" class="btn btn-success btn-custom waves-effect waves-light">Delete Selected Attendance Details</button>
                                 </div>
                              </div>
                              </div>
                              </div>
...
<script src="${pageContext.request.contextPath}/resources/edumaatalert/edumaatalert.js"></script>
 <script src="${pageContext.request.contextPath}/resources/themes/assets/js/bootstrap.min.js"></script> 
  <script src="${pageContext.request.contextPath}/resources/themes/assets/js/detect.js"></script>
   ...
   <script src="${pageContext.request.contextPath}/resources/themes/script/moduleattendancereport.js"></script>
