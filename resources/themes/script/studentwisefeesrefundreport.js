...
var exportfilename='Student_Wise_Fees_Refund_Report_'+datetime;
            		...
            		$("#backButton").show();
                	 if($('input[name=option]:checked').val()=='byFeesCategory'){
                		 ...
                		 var feesCategoryId=$("#feesCategoryList").val();
						    ...
						    {
						        type: "GET",
						        url:ctx+"/report/studentWise/feesCategoryReport/refund",
						        data:data,
						        		...
						        		var datatable = $('#pendingFeesByFeesCategoryTable').DataTable();
							        	 $(".form-horizontal").trigger('reset'); 
											  ...
											  $.each(response, function (i, studentInvoice) {
												  ...
												  $.each(studentInvoice.studentFeeRefundReceipts, function (indexForInvoiceDetail, studentFeeRefundReceipt) {
													  	  refundAmount+=studentFeeRefundReceipt.amount
												  ...
												  if(studentInvoice!=null){
													  var name;
											        	if(studentInvoice.student.lastName!=null){
											        	   ...
											        	   datatable.row.add([name,studentInvoice.student.admissionNo,studentInvoice.student.studentClass.className+"/"+studentInvoice.student.section.sectionName,studentInvoice.feesTerm.feesTermName,refundAmount]).draw( false );
                		 ...
                		 $.ajax(	
      						    {
      						        type: "GET",
      						        url:ctx+"/report/studentWise/feesItemReport/refund",
      						        data: data,
      						        contentType: "application/json; charset=utf-8",
      						        dataType: "json",
      						        cache: false,
