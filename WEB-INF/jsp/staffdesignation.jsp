...
<div class="container">
      <div class="loader"  style="display: none"></div>
            <div id="ListDiv" style="display:block;">
             <security:authorize access="hasRole('staffdesignation/add')">
             <div class="form-group">
                  <button type="button" class="btn btn-primary btn-custom waves-effect waves-light col-md-3" onclick="showDiv()">Add New Staff Designation</button>
               </div>
                <br />
               <br />
               <div class="x_title">
               ...
               <br />
                 ...
                 <security:authorize access="hasRole('staffdesignation/viewlist')">
                      <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Staff Designation</b></h4>
                              ...
                              <thead>
                                 <tr>
                                   	<th>Staff Designation Name</th>
                                   	<th>Staff Type</th>
                                   	<security:authorize access="hasAnyRole('staffdesignation/view','staffdesignation/delete')">
                                   		<th>Action</th>	
                                   	</security:authorize>
                               	</tr>
                              </thead>
                             ...
                             <c:if test="${!empty staffDesignations }">
                              <c:forEach items="${staffDesignations}" var="staffDesignation">
                                 <tr>
                                    <td>${staffDesignation.getStaffDesignationName()}</td>
                                    <td>${staffDesignation.getStaffType().getStaffTypeName()}</td>
                                    <security:authorize access="hasAnyRole('staffdesignation/view','staffdesignation/delete')">
                                    	 <td>
                                    	 <security:authorize access="hasRole('staffdesignation/view')">
                                    	 	<a href="#" id="edit"  type="button"data-href="#" data-id="${staffDesignation.getStaffDesignationId()}" data-toggle="modal"onclick="showeditDiv()">
                                       	<i class="fa fa-pencil" style="margin-right: 15px"></i>
                                       		</a>
                                    	 </security:authorize>
                                       	<security:authorize access="hasRole('staffdesignation/delete')">
                                       		<a href="#"  id="delete"  type="button" data-href="#"  data-id="${staffDesignation.getStaffDesignationId()}" data-toggle="modal" data-target="#deletedesignationconfirmation">
            ...
            <div class="modal fade" id="deletedesignationconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                          <form id="deletedesignationform" action="${pageContext.request.contextPath}/staffdesignation/delete" method="post">
                              <input type="hidden" id="deleteStaffDesignationId" name="deleteStaffDesignationId">
                     		<a href="" id="confirmdeletedesignation"  class="btn btn-primary" type="button">Yes
                            </a>
                            </form>
                     </div>
                  </div>
            ...
            <div class="modal fade" id="designationsaveconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                     ...
                     <div class="modal-body">
                        <h5>Are you sure you want to add this designation ?</h5>
                     </div>
                     <div class="modal-footer">
                        <button type="button" id="designationsaveconfirm" class="btn btn-primary" data-dismiss="modal">Yes</button>
                     </div>
                  </div>
               </div>
            </div> <div class="modal fade" id="designationupdateconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                  <div class="modal-dialog" role="document">
                     <div class="modal-content">
                        <div class="modal-header">
                           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                           <h5>Are you sure you want to update this designation ?</h5>
                        </div>
                        <div class="modal-footer">
                           <button type="button" name="designationupdateconfirm" id="designationupdateconfirm" class="btn btn-primary" data-dismiss="modal">Yes</button>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Create New Staff Designation</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                  <form class="form-horizontal" id="adddesignationform" action="${pageContext.request.contextPath}/staffdesignation/add" method="post">
                                   ...
                                   <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Staff Designation Name<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" id="staffDesignationName" name="staffDesignationName" class="form-control" placeholder="" required="required" maxlength="150">
                                 </div>
                                 </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-sm-offset-3">
                                    ...
                                    <button style="float:right"  type="button" id="savedesignation" class="btn btn-success btn-custom waves-effect waves-light">Save</button>
           ...
           <div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Edit Staff Designation</h2>             
                                                  </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                  <form class="form-horizontal" id="updatedesignationform" action="${pageContext.request.contextPath}/staffdesignation/update" method="post">
                          
                                       <div class="form-group">
                                       <label for="" class="col-sm-3 control-label">Staff Type</label> 
                                       <div class="col-sm-7">
                                           <select  name="editStaffTypeId" id="editStaffTypeId" class="selectpicker" data-live-search="true"  data-style="btn-white">
                                           		<option value="" disabled selected>Select Type</option>
	                                           	  <c:if test="${!empty staffTypes}">
		                                       		 <c:forEach items="${staffTypes}" var="staffType">
		                                       			<option value="${staffType.getStaffTypeId()}">${staffType.getStaffTypeName()}</option>
                                   ...
                                   <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Staff Designation Name</label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" id="editStaffDesignationyName" name="editStaffDesignationName" class="form-control"  placeholder="">
                                 </div>
                                 </div>
                                  <input type="hidden" id="updateDesignationId" name="updateDesignationId">
                                  	<security:authorize access="hasRole('staffdesignation/update')">
                                <div class="row">
                                 <div class="col-sm-offset-3">
                                <a href="#" id="updatedesignation" style="float:right" class="btn btn-success btn-custom waves-effect waves-light" type="button" data-href="#" data-id="" data-toggle="modal" >
                                    				Update
                                    			</a>     
                                    <button style="float:right" type="reset" class="btn btn-info btn-custom waves-effect waves-light">Clear</button>
                                       <button style="float: right" type="button" class="btn btn-danger btn-custom waves-effect waves-light" onclick="location.reload();">Cancel</button>
...
<script type="text/javascript">
    ...
    TableManageButtons.init();
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/staffdesignation.js" type="text/javascript"></script>
