...
public class StudentMovementRequisitionException
extends EdumaatException {
    private static final long serialVersionUID = 1L;

    public StudentMovementRequisitionException(Message message) {
        super(message);
    }

    public StudentMovementRequisitionException(ComplaintManagementException e, Message message) {
        super(e, message);
    }
}
