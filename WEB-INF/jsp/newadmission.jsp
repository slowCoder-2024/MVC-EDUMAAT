...
<html>
   ...
   <div id="myTabContent" class="tab-content">
      ...
      <br>
         <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Applicant Code<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                               <!--   <input class="form-control" placeholder="Enter Applicant Code" type="text" id="applicantCode" name="applicantCode" required="required"> -->
								   <select name="applicantCode" id="applicantCode" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                                            
                                              <option value="">Select Applicant Code</option>
                                          </select> 
								 </div>
                              </div>
    	<div class="form-group">
