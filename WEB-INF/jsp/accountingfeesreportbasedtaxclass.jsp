          ...
          <tfoot >
            <tr style=" background-color: aqua;">
             <th style="border: none;"> </th>
                  ...
                  <th  id="accountgrandoutstanding" style="text-align:center;border: none;"></th>
                   <th  id="accountgrandtotalwithouttax" style="text-align:center;border: none;"></th>
                    <th  id="accountgrandtotaltaxamount" style="text-align:center;border: none;"></th>
                    <th  id="accountgrandtotaltaxpercentage" style="text-align:center;border: none;"></th>
            ...
            <th style="border: none;"> </th>
                  ...
                  <th  id="accountpageoutstanding" style="text-align:center;border: none;"></th>
                   <th  id="accountpagetotalwithouttax" style="text-align:center;border: none;"></th>
                  <th  id="accountpagetotaltaxamount" style="text-align:center;border: none;"></th>
                  <th  id="accountpagetotaltaxpercentage" style="text-align:center;border: none;"></th>
                   <th  style="text-align:center;border: none;"></th>
...
<script src="${pageContext.request.contextPath}/resources/themes/script/accountingfeesreportbasedtaxclass.js"></script>
<script type="text/javascript">
