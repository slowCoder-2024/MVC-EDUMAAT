...
<div class="container">
      <div class="loader"  style="display: none"></div>
              ...
              <security:authorize access="hasRole('timetablegenerator/add')">
                  <div class="form-group">
                     <button type="button" class="btn btn-primary btn-custom waves-effect waves-light col-md-3" onclick="showTimeTableGeneratorDiv()">Generate Time Table</button>
                  </div>
         ...
         <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Time Table Generator</b></h4>
                                                  ...
                                                  <security:authorize access="hasRole('timetablegenerator/view')">
                                                   <a href="#" id="edit"  type="button"data-href="#" data-id="${timeTableGeneratorList.getTimeTableGeneratorId()}" data-toggle="modal" onclick="editTimeTableGeneratorDiv()">
                                                    <i class="fa fa-pencil" style="margin-right: 15px"></i>
                                                     ...
                                                     <security:authorize access="hasRole('timetablegenerator/delete')">
                                                   <a href="#"  id="delete"  type="button" data-href="#"  data-id="${timeTableGeneratorList.getTimeTableGeneratorId()}" data-toggle="modal" data-target="#confirm_delete_timeTableGenerator">
                ...
                <div class="modal fade" id="confirm_delete_timeTableGenerator" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                           <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                 ...
                                 <form id="deleteTimeTableGeneratorForm" action="${pageContext.request.contextPath}/timetable/generator/delete" method="post">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              ...
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="timeTableGeneratorForm" action="${pageContext.request.contextPath}/timetable/generator/add" method="post">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                   <select name="timetabletemplate" id="timetabletemplate" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required" disabled="disabled">
               ...
               <div id="EditTimeTableGeneratorDiv" style="display:none;">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">View/Edit Time Table Generator</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="updateTimeTableGeneratorForm" action="${pageContext.request.contextPath}/timetable/generator/update" method="post">
                ...
                <div class="modal fade" id="timeTableGeneratorUpdateConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										 <h5>Are you sure you want to update time table generator ?</h5>
									</div>
									<div class="modal-footer">
 ...
 <script src="${pageContext.request.contextPath}/resources/edumaatalert/edumaatalert.js"></script>
  <script src="${pageContext.request.contextPath}/resources/themes/assets/js/detect.js"></script>
   ...
   <script src="${pageContext.request.contextPath}/resources/themes/assets/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/timetablegenerator.js" type="text/javascript"></script> 
