...
<div class="container">
      <div class="loader"  style="display: none"></div>
             ...
             <div id="TimeTableGeneratorDiv" style="display:block;">
          <div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="m-t-0 header-title" style="color:purple;">My TimeTable</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                        <form class="form-horizontal" id="timeTableViewForm" >
					...
					<strong>Info!</strong>&nbsp;Time Table UnAvailable For This Class...!
					</div>
                                   <div class="row" id="row" >
                              <div class="col-sm-offset-3">
                                 <!-- <button style="float:right"  type="button" id="printtimetable" class="btn btn-info">Print Time Table</button> -->
                                 </div>
                           </div>
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/resources/themes/script/studenttimetable.js" type="text/javascript"></script> 
 <script type="text/javascript">
