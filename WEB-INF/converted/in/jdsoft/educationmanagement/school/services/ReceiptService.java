...
public interface ReceiptService {
    public static final Logger log = LogManager.getLogger((String)ReceiptService.class.getName());
    ...
    public ArrayList<StudentReceipt> getStudentReceiptsByPaymentMode(Long var1);

    public ArrayList<StudentReceipt> getStudentReceiptsFromPaymentModeAndStatus(Long var1, Long var2);

    public void updateReconcillation(Long[] var1, Long var2, Date var3, String var4, String var5) throws StudentReceiptException;

    public void updateChequeReconcillation(Long[] var1, Long var2, Date var3, String var4, String var5) throws StudentReceiptException;

    public void updateDdReconcillation(Long[] var1, Long var2, Date var3, String var4, String var5) throws StudentReceiptException;

    public StudentReceipt getStudentReceiptDetails(Long var1) throws ParseException;

    public ArrayList<StudentReceipt> getAllStudentReceipts(AcademicYear var1, Class var2, Section var3);

    public ArrayList<StudentReceipt> getAllStudentsReceipts(AcademicYear var1, Institution var2);

    public ArrayList<StudentReceipt> getStudentReceiptsBySpecialCategory(AcademicYear var1, Class var2, Section var3, SpecialCategory var4);

    public ArrayList<StudentReceipt> getStudentReceiptsBySpecialCategory(AcademicYear var1, SpecialCategory var2, Institution var3);

    public ArrayList<StudentReceipt> getStudentReceiptsByAdmisssionNo(String var1);

    public ArrayList<StudentReceipt> getStudentReceiptsByAdmisssionNoAndAcademicYear(String var1, AcademicYear var2);

    public void deleteReceipt(Long var1);

    public ArrayList<StudentReceipt> getReceiptsByDateRange(Date var1, Date var2, Institution var3);

    public Long amountTobeCollectedOnPercentageDiscount(Long[] var1, Double var2);

    public Long amountTobeCollectedForRefund(Long[] var1);
    ...
    public ArrayList<SixFieldReports> getStudentReceiptsByDateRange(Long var1, Date var2, Date var3, Long var4) throws Exception;

    public void deleteStudentReceiptsByAcademicYear(Long[] var1, Long var2) throws Exception, StudentReceiptException;

    public StudentReceipt receiptById(Long var1) throws Exception;
