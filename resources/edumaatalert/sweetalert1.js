...
var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('./modules/handle-edumaat-dom');
 ...
 */
var sweetAlert, edumaat;

exports['default'] = sweetAlert = edumaat = function () {
  ...
  switch (typeof customizations) {
    ...
    // Ex: edumaat("Hello", "Just testing", "info");
    case 'string':
    ...
    // Ex: edumaat({ title:"Hello", text: "Just testing", type: "info" });
    case 'object':
 ...
 */
sweetAlert.setDefaults = edumaat.setDefaults = function (userParams) {
  if (!userParams) {
 ...
 */
sweetAlert.close = edumaat.close = function () {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.showInputError = edumaat.showInputError = function (errorMessage) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.resetInputError = edumaat.resetInputError = function (event) {
 ...
 */
sweetAlert.disableButtons = edumaat.disableButtons = function (event) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.enableButtons = edumaat.enableButtons = function (event) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
  var $confirmButton = modal.querySelector('button.confirm');
  var $cancelButton = modal.querySelector('button.cancel');
...
if (typeof window !== 'undefined') {
  ...
  window.sweetAlert = window.edumaat = sweetAlert;
} else {
  _extend$hexToRgb$isIE8$logStr$colorLuminance.logStr('SweetAlert is a frontend module!');
}
module.exports = exports['default'];

},{"./modules/default-params":2,"./modules/handle-click":3,"./modules/handle-dom":4,"./modules/handle-key":5,"./modules/handle-edumaat-dom":6,"./modules/set-params":8,"./modules/utils":9}],2:[function(require,module,exports){
'use strict';
...
var _getModal = require('./handle-edumaat-dom');
...
},{"./handle-dom":4,"./handle-edumaat-dom":6,"./utils":9}],4:[function(require,module,exports){
'use strict';
...
var _setFocusStyle = require('./handle-edumaat-dom');
...
},{"./handle-dom":4,"./handle-edumaat-dom":6}],6:[function(require,module,exports){
'use strict';
...
var _getModal$getInput$setFocusStyle = require('./handle-edumaat-dom');
    ...
    var _ret = (function () {
      ...
      switch (params.type) {
        ...
        case 'prompt':
          ...
          setTimeout(function () {
            $input.focus();
            $input.addEventListener('keyup', edumaat.resetInputError);
          }, 400);
          break;
      }
    })();
...
},{"./handle-dom":4,"./handle-edumaat-dom":6,"./utils":9}],9:[function(require,module,exports){
'use strict';
