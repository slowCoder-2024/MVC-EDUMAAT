          ...
          $(document).ready(function(){
        	  ...
        	  var receiptId=${receiptId}
        		 $('#invprint').modal('show');
 			        	...
 			        	$('#printinv,#printpreview').attr("href",ctx+"/receipt/printPage?receiptId="+receiptId);
              ...
              <th style="border: none;"> </th>
             	...
             	<div id="confirmedInvoiceFormDiv" style="display:none;">
						...
						<div class="panel-body">
                      	...
                      	<br>
                      	<h5 class="m-t-0 header-title" style="color:purple;font-size: 20px;">Please Select Fees Item(s) Before Proceeding To Pay</h5>
             	...
             	<div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                  <h3 class="m-t-0 header-title" style="color:purple;">Payment Mode Details</h3>
                                </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                                 	<div class="panel-default">
						...
						<div class="panel-body">
             				<form class="form-horizontal" id="paymentDetailsPanelForm" action="${pageContext.request.contextPath}/receipt/generate/payment" method="post">
                  ...
                  <br>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7"> 
                                    <input type="text" class="form-control" readonly="readonly" id="fineAmount" name="fineAmount" onkeypress="return decimalAmount(this, event, 2)" placeholder="">
                                 </div>
                              </div>
                             <div class="form-group">
