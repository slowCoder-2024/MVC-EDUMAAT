                  ...
                  <div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-primary">
                              <div class="panel-heading">
                               <h2 class="panel-title ">
					Select Student(s) to Delete Generated But Unpaid Invoice(s)
		           </h2>
                                </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
             ...
             <form class="form-horizontal" id="generateinvoiceform" method="post" action="${pageContext.request.contextPath}/invoice/invoiceDelete">
                  ...
                  <div class="form-group">
                         ...
                         <input id="selectedStudentIds" name="selectedStudentIds" type="hidden"> 
             					 <div class="row">
                                 		<div class="col-sm-offset-3">
                                            <button style="float:right" type="button" id="deletegenerateinvoice" class="btn btn-info btn-custom waves-effect waves-light">Delete Generate Invoice(s)</button>
									   </div>
                              </div>
                        </form>  
                        </div>
