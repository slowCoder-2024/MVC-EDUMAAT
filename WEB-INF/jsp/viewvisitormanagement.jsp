...
<html lang="en">
  <head>
   <meta charset="utf-8">
      ...
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/themes/validator/css/validate.css">
...
<div class="container">
	...
	<div class="row"  >
<div style="height:400px;border-top:2px solid black;border-bottom:2px solid black;border-left:2px solid black;border-right:2px solid black; " class="col-lg-5 col-sm-6">
<br/>
<table class="table">
<thead >
<tr >
<td style="text-align:left;"><img width="120px" height="100px" src="${pageContext.request.contextPath}${visitorManagementList.getInstitution().getInstitutionLogo()}"></img></td>
<td style="margin-left:-150px;"><h2 ><label >${visitorManagementList.getInstitution().getInstitutionName()}</label></h2><h4 ><label >${visitorManagementList.getInstitution().getInstitutionAddressline1()},${visitorManagementList.getInstitution().getInstitutionAddressline2()},${visitorManagementList.getInstitution().getInstitutionCity()}-${visitorManagementList.getInstitution().getInstitutionPostcode()}</label></h4></td>
</tr>
</thead>
<tbody>
</tbody>
...
<table class="table"><tbody style="height:201px;">
<tr>
<td style="text-align:left;">Visitor Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${visitorManagementList.getVisitorName()}</label>
</td>
</tr>
<tr>
<td style="text-align:left;">Visitor Email&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${visitorManagementList.getVisitorEmail()}</label>
</td>
</tr>
<tr>
<td style="text-align:left;">Visitor Mobile Number&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${visitorManagementList.getVisitorMobileNumber()}</label>
</td>
</tr>

<tr>
<td style="text-align:center;"><img width="200px" height="40px" src="${pageContext.request.contextPath}${visitorManagementList.getInstitution().getAuthorizedSignature()}"></img><br/>Principal
</td>
</tr>
</tbody></table></div>
</div>
<div class="col-lg-5 col-sm-6" style="height:400px;border-left:2px solid black;border-top:2px solid black;border-bottom:2px solid black;border-right:2px solid black;">
<br/>
<table class="table">
<tbody>
<tr>
<td style="text-align:left;">Date&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;"><fmt:formatDate pattern="dd/MM/yyyy" value="${visitorManagementList.getVisitDate()}" /></label>
</td>
</tr>
<tr>
<td style="text-align:center;">
<img width="150px" height="150px" src="${pageContext.request.contextPath}${visitorManagementList.getVisitorIDCardGeneration().getQrImage()}"></img><br/>${visitorManagementList.getVisitorIDCardGeneration().getQrCode()}
</td>
</tr>
</tbody>
</table>
