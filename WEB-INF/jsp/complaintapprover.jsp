...
<div class="container">
      <div class="loader"  style="display: none"></div>
       ...
       <div class="row">
                        ...
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Complaint Approvals</b></h4>
                              ...
                              <tbody id="complaintApprovePendingLists">
                     	<c:if test="${!empty complaintApprovePendingList}">
                                     <c:forEach items="${complaintApprovePendingList}" var="complaintApprovePendingList">
                                     	<tr >
                                     	  <td>${complaintApprovePendingList.getComplaintSender().getName()}</td>
                                     	   <td><fmt:formatDate pattern="dd/MM/yyyy" value="${complaintApprovePendingList.getCreatedDate()}" /></td>
		                                    <td>${complaintApprovePendingList.getComplaintReason()}</td>
		                                     <td> 
	                                    <input  class="form-control"  required="required" id="complaintApproverComment${complaintApprovePendingList.getComplaintId()}" name="complaintApproverComment${meetingRequisitionApprovals.getComplaintId()}" placeholder="" />
	                             		 </td>
		                                   	<td>
		                                   	  	<a href="#" id="complaintApprove"  type="button" data-href="#" data-id="${complaintApprovePendingList.getComplaintId()}" >
                                               <span class="label label-table label-success"> 	<i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>
                                                </a>
                                                 	<a href="#" id="complaintRejection"  type="button" data-href="#" data-id="${complaintApprovePendingList.getComplaintId()}">
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <h5>Are you sure ?, You want to Reject this Complaint ??</h5>
                     </div>
            ...
            <div class="modal fade" id="confirm-approved" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <h5>Are you sure ?, You want to Accept this Complaint ??</h5>
                     </div>
                     <div class="modal-footer">
                       <form id="approvedRequisition" action="${pageContext.request.contextPath}/complaintManagement/updatestatus" method="post">
                              <input type="hidden" id="complaintId" name="complaintId">
                                <input type="hidden" id="complaintApproverComment" name="complaintApproverComment">
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/complaintapprover.js" type="text/javascript"></script>
    </body>
</html>