...
<div class="container">
    ...
    <c:if test="${!empty studentIDCardGenerationLists}">
	       <c:forEach items="${studentIDCardGenerationLists}" var="studentIDCardGenerationList">
	<div class="row"  >
	...
	<img width="120px" height="100px" src="${pageContext.request.contextPath}${studentIDCardGenerationList.getInstitution().getInstitutionLogo()}"></img>
	</td>
	<td style="margin-left:-150px;">
	<h4 >
	<label >${fn:toUpperCase(studentIDCardGenerationList.getInstitution().getInstitutionName())}</label>
	</h4>
	<h5 ><label >${studentIDCardGenerationList.getInstitution().getInstitutionAddressline1()},${studentIDCardGenerationList.getInstitution().getInstitutionAddressline2()},${studentIDCardGenerationList.getInstitution().getInstitutionCity()}-${studentIDCardGenerationList.getInstitution().getInstitutionPostcode()}</label>
	</h5>
	</td>
	</tr>
	</thead>
	...
	<h5>
	<label>
	${fn:toUpperCase("Student Id Card")}
	</label>
	</h5>
	</td>
	</tr>
	<tr>
	<td rowspan="6">
	<img width="180px" height="150px" src="${pageContext.request.contextPath}${studentIDCardGenerationList.getStudent().getUser().getProfilePicturePath()}"></img>
	</td>
	<td style="text-align:left;">Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudent().getFirstName()}${studentIDCardGenerationList.getStudent().getLastName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Class Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudentClass().getClassName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Section Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getSection().getSectionName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Admission No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getAdmissionNo()}</label></td>
	</tr>
	<tr>
	<td style="text-align:center;"><img width="200px" height="40px" src="${pageContext.request.contextPath}${studentIDCardGenerationList.getInstitution().getAuthorizedSignature()}"></img><br/>Principal</td>
	</tr>
	</tbody>
	</table>
	</div>
	...
	<tbody>
	<tr>
	<td style="text-align:left;">Date of Birth&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;"><fmt:formatDate pattern="dd/MM/yyyy" value="${studentIDCardGenerationList.getStudent().getBirthDate()}"/></label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Blood Group&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getBloodGroup().getBloodGroupName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Father Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudent().getParentGuardianFirstName()} ${studentIDCardGenerationList.getStudent().getParentGuardianLastName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Address&nbsp;&nbsp;:&nbsp;&nbsp;<label>${studentIDCardGenerationList.getStudent().getAddressLine1()},${studentIDCardGenerationList.getStudent().getAddressLine2()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudent().getCity() } - ${studentIDCardGenerationList.getStudent().getPostcode()}</label>
	</td>
	</tr>
	<tr>
	<td style="text-align:left;">Student Contact No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudent().getContact()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Parent Contact No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentIDCardGenerationList.getStudent().getParentContact()}</label></td>
	</tr>
	<tr>
	<td><img width="250px" height="50px" src="${pageContext.request.contextPath}${studentIDCardGenerationList.getBarCodeImage()}"></img><br/>${studentIDCardGenerationList.getBarCode()}</td>
	</tr>
	</tbody>
	</table>
	</div>
