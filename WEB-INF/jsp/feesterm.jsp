...
<div class="container">
   <div class="loader" style="display: none"></div>
               ...
               <security:authorize access="hasRole('feesterm/add')">
                  <div class="form-group">
                     <button type="button" class="btn btn-primary btn-custom waves-effect waves-light col-md-3" onclick="showDiv()">Add New Fees Category</button>
                  </div>
                  <div class="x_title">
                     <div class="clearfix">
                     </div>
                  ...
                  <security:authorize access="hasRole('feesterm/viewlist')">
               <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Fees Category</b></h4>
                        <table  data-toggle="table"
                           ...
                           <thead style="background-color:#673AB7;color:#ffffff;">
                              <tr>
                                 ...
                                 <security:authorize access="hasAnyRole('feesterm/delete','feesterm/view')">
                                 <th>Action</th>
                                 </security:authorize>
                              </tr>
                           </thead>
                              ...
                              <c:if test="${!empty feesTerms}">
                                 <c:forEach items="${feesTerms}" var="feesTerm">
                                    <tr >
                                       ...
                                       <security:authorize access="hasAnyRole('feesterm/delete','feesterm/view')">
                                       <td>
                                          <security:authorize access="hasRole('feesterm/view')">
                                          ...
                                          <security:authorize access="hasRole('feesterm/delete')">
                ...
                <div class="modal fade" id="updateConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										 <h5>Are you sure you want to update fees category ?</h5>
									</div>
                           ...
                           <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <h5>Are you sure ?, You want to delete this fees category ??</h5>
                                 </div>
                                 <div class="modal-footer">
                                 	<form id="deleteFeesTermForm" action="${pageContext.request.contextPath}/feesTerm/delete" method="post">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Create New Fees Category</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="feesTermform" action="${pageContext.request.contextPath}/feesTerm/add" method="post">
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Fees Category Name<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-offset-3">
                                    <button style="float:right"  type="button" id="feesTermSave" class="btn btn-success btn-custom waves-effect waves-light">Save</button>
                  ...
                  <div class="modal fade" id="feesTermSaveConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <h5>Are you sure ?, You want to create new fees category ??</h5>
                           </div>
                           <div class="modal-footer">
              ...
              <div class="row" id="error">
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Edit Fees Category</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="updateFeesTermForm" action="${pageContext.request.contextPath}/feesTerm/update" method="post">
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Fees Category Name<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                               ...
                               <security:authorize access="hasRole('feesterm/update')">
                              <div class="row">
                                <span style="float:left;margin-top:0px;"class="at-required-highlight">Mandatory fields are marked with an asterisk (*)</span>
                                 <div class="col-sm-offset-3">
                                     <a href="#" id="updateFeesTerm" style="float:right" class="btn btn-success btn-custom waves-effect waves-light" type="button" data-id=""  >
                                    				Update
                                    			</a>   
                                    <button style="float:right" type="reset" class="btn btn-info btn-custom waves-effect waves-light">Clear</button>
                                     <button style="float: right" type="button" class="btn btn-danger btn-custom waves-effect waves-light" onclick="location.reload()">Cancel</button>
