                              ...
                              <tbody id="approvalsList">
                              	<c:if test="${!empty leaveApporvalsList}">
                                     <c:forEach items="${leaveApporvalsList}" var="leaveApporvals">
                                     	<tr >
		                                  	<td>${leaveApporvals.getStudent().getFirstName()} ${leaveApporvals.getStudent().getLastName()}</td>
		                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${leaveApporvals.getCreatedDate()}" /></td>
		                                    <td>${leaveApporvals.getStudentLeaveReason()}</td>
		                                    <td>${leaveApporvals.getStudentLeaveType().getStudentLeaveType()}</td>
		                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${leaveApporvals.getStudentLeaveStartDate()}" /> - <fmt:formatDate pattern="dd/MM/yyyy" value="${leaveApporvals.getStudentLeaveEndDate()}" /></td>
		                                    <td> 
	                                    <input  class="form-control"  required="required" id="approverComment${leaveApporvals.getStudentLeaveRequisitionId()}" name="approverComment${leaveApporvals.getStudentLeaveRequisitionId()}" placeholder="" />
	                             		 </td>
		                                   	<td>
		                                   	  	<a href="#" id="studentLeaveApprove"  type="button" data-href="#" data-id="${leaveApporvals.getStudentLeaveRequisitionId()}" >
                                               <span class="label label-table label-success"> 	<i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>
                                                </a>
                                                 	<a href="#" id="studentLeaveRejection"  type="button" data-href="#" data-id="${leaveApporvals.getStudentLeaveRequisitionId()}">
                                                	<span class="label label-table label-danger"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></span>
                                                </a>
                                              <%--   <a href="#" id="staffLeavePartiallyApprove"  type="button" data-href="#" data-id="${leaveApporvals.getStudentLeaveRequisitionId()}">
                                                	<span class="label label-table label-info"><label>partially leave approve</label></span>
                                                </a> --%>
		                                   	</td>
                                   		</tr>
                                     </c:forEach>
                        ...
                        <div class="col-sm-12">
                           <div class="card-box">
                              ...
                              <tbody id="movementapprovalsList">
                              	<c:if test="${!empty studentMovementApporvalsList}">
                                     <c:forEach items="${studentMovementApporvalsList}" var="movementApporvals">
                                     	<tr >
		                                  	<td>${movementApporvals.getStudent().getFirstName()} ${movementApporvals.getStudent().getLastName()}</td>
		                                    ...
		                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${movementApporvals.getStudentMovementDate()}" /> </td>
		                                    <td> 
	                                    <input  class="form-control"  required="required" id="movementApproverComment${movementApporvals.getStudentMovementRequisitionId()}" name="movementApproverComment${movementApporvals.getStudentMovementRequisitionId()}" placeholder="" />
	                             		 </td>
		                                   	<td>
		                                   	  	<a href="#" id="studentMovementApprove"  type="button" data-href="#" data-id="${movementApporvals.getStudentMovementRequisitionId()}" >
                                               <span class="label label-table label-success"> 	<i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>
                                                </a>
                                                 	<a href="#" id="studentMovementRejection"  type="button" data-href="#" data-id="${movementApporvals.getStudentMovementRequisitionId()}">
                                                	<span class="label label-table label-danger"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></span>
                                                </a>
            ...
            <div class="modal fade" id="confirm-approved" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                       <form id="approvedLeaveRequisition" action="${pageContext.request.contextPath}/student/leave/approvals/updatestatus" method="post">
                              <input type="hidden" id="studentLeaveRequisitionId" name="studentLeaveRequisitionId">
                               <input type="hidden" id="studentLeaveRequisitionStatus" name="studentLeaveRequisitionStatus">
            ...
            <div class="modal fade" id="movementconfirm-approved" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                       <form id="approvedMovementRequisition" action="${pageContext.request.contextPath}/student/studentMovement/approvals/updatestatus" method="post">
                              <input type="hidden" id="studentMovementRequisitionId" name="studentMovementRequisitionId">
                               <input type="hidden" id="studentMovementRequisitionStatus" name="studentMovementRequisitionStatus">
                                  <input type="hidden" id="studentMovementApproverComment" name="studentMovementApproverComment">
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/studentleaveapproval.js" type="text/javascript"></script>
