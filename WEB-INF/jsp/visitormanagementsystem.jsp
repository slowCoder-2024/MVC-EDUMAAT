...
<div class="container">
      <div class="loader"  style="display: none"></div>
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-border panel-pink">
                              <div class="panel-heading">
                                 <h2 class="panel-title">Visitor Form</h2>
                              </div>
                              <div class="panel-body">
                                 <div class="col-lg-12">
                           <form class="form-horizontal" id="visitorManagementForm" action="${pageContext.request.contextPath}/visitormanagement/add" method="post">
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Visitor Name <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7"> 
                                    <input type="text" name="visitorname" class="form-control" id="visitorname" placeholder="" required="required" maxlength="50">
                                 </div>
                              </div>
                             
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Visitor Type<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                    <select name="visitorType" id="visitorType" class="selectpicker" data-live-search="true"  data-style="btn-white" required="required">
                                       <option value="" disabled selected>Select Option</option>
                                     <c:if test="${!empty visitorTypes}">
		                                       			<c:forEach items="${visitorTypes}" var="visitorType">
		                                       				<option value="${visitorType.getVisitorTypeId()}">${visitorType.getVisitorType()}</option>
		                                       			</c:forEach>
		                                       		</c:if>
                                    </select>
                                 </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="email" name="visitoremail" class="form-control" id="visitoremail" placeholder="" required="required" maxlength="100">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Mobile Number<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                    <input type="text" name="visitormobilenumber" class="form-control" id="visitormobilenumber" placeholder="" required="required" maxlength="15">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Whom To Meet<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                    <input type="text" name="visitorwhomtomeet" class="form-control" id="visitorwhomtomeet" placeholder="" required="required" maxlength="100">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Purpose Of Visit<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                    <input type="text" name="visitorpurposeofvisit" class="form-control" id="visitorpurposeofvisit" placeholder="" required="required" maxlength="100">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Date <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                      <input type="text" name="visitorDate" class="form-control" id="visitorDate" placeholder="DD/MM/YYYY" required="required" maxlength="100">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Check In <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                     <input type="text" name="visitorcheckintime" class="form-control timedropper" id="visitorcheckintime" placeholder="HH:mm" required="required" maxlength="100">
                                 </div>
                              </div>
                                <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Check Out <span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-7">
                                     <input type="text" name="visitorcheckouttime" class="form-control timedropper" id="visitorcheckouttime" placeholder="HH:mm" required="required" maxlength="100">
                                 </div>
                              </div>
                              <div class="row">
                                 <span style="float:left;margin-top:0px;"class="at-required-highlight">Mandatory fields are marked with an asterisk (*)</span>
                                 <div class="col-sm-offset-3">
                                    <button style="float:right" type="button" id="savevisitormanagement"  class="btn btn-success btn-custom waves-effect waves-light">Save</button>
           ...
           <div class="row">
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Visitor List's</b></h4>
                                 ...
                                 data-pagination="true" data-show-pagination-switch="true"  class="table-bordered ">
                                    ...
                                    <tbody id="visitorManagementLists">
                                       <c:if test="${!empty visitorManagementList}">
                                          <c:forEach items="${visitorManagementList}" var="visitorManagementList">
                                             <tr>
                                                <td>${visitorManagementList.getVisitorName()}</td>
                                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${visitorManagementList.getVisitDate()}"/></td>
                                                 <td>${visitorManagementList.getVisitorWhomToMeet()}</td>
                                                <td>${visitorManagementList.getVisitorType().getVisitorType()}</td>
                                                  <td>${visitorManagementList.getVisitCheckInTime()}</td>
                                                  <td>${visitorManagementList.getVisitCheckOutTime()}</td>
                                                <td>
                                                   <a href="${pageContext.request.contextPath}/visitormanagement/view?visitorManagementId=${visitorManagementList.getVisitorManagmentId()}" id="edit"  type="button" data-href="#" data-id="${visitorManagementList.getVisitorManagmentId()}" target="_blank" data-toggle="modal">
                                                  <span class="glyphicon glyphicon-eye-open"></span>
                                                   </a>
                                                   <a href=""  id="delete"  type="button" data-href="#"  data-id="${visitorManagementList.getVisitorManagmentId()}" data-toggle="modal" data-target="#recprint">
               ...
               <div class="modal-dialog" role="document">
                ...
                <div class="modal fade" id="deletemoduleconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                           <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                 <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                 ...
                                 <div class="modal-body">
                                  ...
                                  <div class="modal-footer">
                                 <form id="deletemoduleform" action="${pageContext.request.contextPath}/module/delete" method="post">
                ...
                <div class="modal fade" id="visitorSaveConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <h5>Are you sure you want to add this visitor ?</h5>
                           </div>
                           <div class="modal-footer">
...
<script src="${pageContext.request.contextPath}/resources/themes/script/visitormanagement.js" type="text/javascript"></script> 
