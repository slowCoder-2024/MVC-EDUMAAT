...
<div class="container">
    ...
    <c:if test="${!empty studentTransportIDCardGenerationLists}">
	       <c:forEach items="${studentTransportIDCardGenerationLists}" var="studentTransportIDCardGenerationList">
	<div class="row"  >
	...
	<img width="120px" height="100px" src="${pageContext.request.contextPath}${studentTransportIDCardGenerationList.getInstitution().getInstitutionLogo()}"></img>
	</td>
	<td style="margin-left:-150px;">
	<h4 >
	<label >${fn:toUpperCase(studentTransportIDCardGenerationList.getInstitution().getInstitutionName())}</label>
	</h4>
	<h5 ><label >${studentTransportIDCardGenerationList.getInstitution().getInstitutionAddressline1()},${studentTransportIDCardGenerationList.getInstitution().getInstitutionAddressline2()},${studentTransportIDCardGenerationList.getInstitution().getInstitutionCity()}-${studentTransportIDCardGenerationList.getInstitution().getInstitutionPostcode()}</label>
	</h5>
	</td>
	</tr>
	</thead>
	...
	<h5>
	<label>
	${fn:toUpperCase("Student Transport Id Card")}
	</label>
	</h5>
	</td>
	</tr>
	<tr>
	<td rowspan="6">
	<img width="180px" height="150px" src="${pageContext.request.contextPath}${studentTransportIDCardGenerationList.getStudent().getUser().getProfilePicturePath()}"></img>
	</td>
	<td style="text-align:left;">Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudent().getFirstName()}${studentTransportIDCardGenerationList.getStudent().getLastName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Class Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudentClass().getClassName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Section Name&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getSection().getSectionName()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Admission No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudent().getAdmissionNo()}</label></td>
	</tr>
	<tr>
	<td style="text-align:center;"><img width="200px" height="40px" src="${pageContext.request.contextPath}${studentTransportIDCardGenerationList.getInstitution().getAuthorizedSignature()}"></img><br/>Authorized Signature</td>
	</tr>
	</tbody>
	</table>
	</div>
	...
	<tr>
	<td>
	<img width="150px" height="150px" src="${pageContext.request.contextPath}/resources/themes/images/bus.png"></img>
	</td>
	</tr>
	<tr>
	<td style="text-align:left;">Address&nbsp;&nbsp;:&nbsp;&nbsp;<label>${studentTransportIDCardGenerationList.getStudent().getAddressLine1()},${studentTransportIDCardGenerationList.getStudent().getAddressLine2()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudent().getCity() } - ${studentTransportIDCardGenerationList.getStudent().getPostcode()}</label>
	</td>
	</tr>
	<tr>
	<td style="text-align:left;">Student Contact No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudent().getContact()}</label></td>
	</tr>
	<tr>
	<td style="text-align:left;">Parent Contact No&nbsp;&nbsp;:&nbsp;&nbsp;<label style="text-align:right;">${studentTransportIDCardGenerationList.getStudent().getParentContact()}</label></td>
	</tr>
	<tr>
	<td><img width="250px" height="50px" src="${pageContext.request.contextPath}${studentTransportIDCardGenerationList.getBarCodeImage()}"></img><br/>${studentTransportIDCardGenerationList.getBarCode()}</td>
	</tr>
	</tbody>
	</table>
	</div>
