...
<html>
   ...
   <body class="fixed-left">
               ...
               <div class="container">
                  <div class="loader"  style="display: none"></div>
                    <div class="row">
                        <div class="col-md-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title"><b>TODAY'S ATTENDANCE</b></h4>
                              <br>
                              <div class="row text-center">
                                 <div class="col-sm-6 col-lg-4" class="studentAttendancePercentage1">
                                    <div id="studentAttendancePercentage" class="circliful-chart m-b-30 circliful-chart1" data-dimension="200"  data-text="" data-info="Student" data-width="20" data-fontsize="24" data-percent="" data-fgcolor="#5fbeaa" data-bgcolor="#ebeff2" data-fill="#f4f8fb"></div>
                                 </div>
                                 <div class="col-sm-6 col-lg-4" class="tstaffAttendancePercentage">
                                    <div id="tstaffAttendancePercentage" class="circliful-chart m-b-30 circliful-chart2" data-dimension="200" data-text="" data-info="Teaching Staff" data-width="30" data-fontsize="24" data-percent="" data-fgcolor="#7266ba" data-bgcolor="#ebeff2"></div>
                                 </div>
                                 <div class="col-sm-6 col-lg-4" class="ostaffAttendancePercentage">
                                    <div id="ostaffAttendancePercentage" class="circliful-chart m-b-30 circliful-chart3" data-startdegree="90" data-dimension="200" data-text="" data-info="Non-Teaching Staff" data-width="30" data-fontsize="24" data-percent="" data-fgcolor="#61a9dc" data-bgcolor="#ebeff2"></div>
                                 </div>
                              </div>
                           </div>
                        </div>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/todayattendance.js"></script>
      <script type="text/javascript">
