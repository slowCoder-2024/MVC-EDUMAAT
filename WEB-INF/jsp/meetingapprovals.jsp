...
<div class="container">
      <div class="loader"  style="display: none"></div>
       ...
       <div class="row">
                        ...
                        <div class="col-sm-12">
                           <div class="card-box">
                              <h4 class="m-t-0 header-title" style="color:purple;"><b>Meeting Approvals</b></h4>
                              ...
                              <tbody id="meetingapprovalsList">
                     	<c:if test="${!empty meetingRequisitionApprovalsList}">
                                     <c:forEach items="${meetingRequisitionApprovalsList}" var="meetingRequisitionApprovals">
                                     	<tr >
                                     	  
                                     	  <td>${meetingRequisitionApprovals.getMeetingRequester().getName()}</td>
                                     	   
		                                   <td><fmt:formatDate pattern="dd/MM/yyyy" value="${meetingRequisitionApprovals.getCreatedDate()}" /></td>
		                                    <td>${meetingRequisitionApprovals.getRequestReason()}</td>
		                                     <td>${meetingRequisitionApprovals.getStartTime() }</td>
		                                    <td>${meetingRequisitionApprovals.getEndTime() }</td>
		                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${meetingRequisitionApprovals.getRequisitionDate()}" /> </td>
		                                    <td> 
	                                    <input  class="form-control"  required="required" id="meetingApproverComment${meetingRequisitionApprovals.getMeetingRequisitionId()}" name="meetingApproverComment${meetingRequisitionApprovals.getMeetingRequisitionId()}" placeholder="" />
	                             		 </td>
		                                   	<td>
		                                   	  	<a href="#" id="meetingApprove"  type="button" data-href="#" data-id="${meetingRequisitionApprovals.getMeetingRequisitionId()}" >
                                               <span class="label label-table label-success"> 	<i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>
                                                </a>
                                                 	<a href="#" id="meetingRejection"  type="button" data-href="#" data-id="${meetingRequisitionApprovals.getMeetingRequisitionId()}">
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                       <form id="rejectedRequisition" action="${pageContext.request.contextPath}/staff/approvals/meeting/updatestatus" method="post">
            ...
            <div class="modal fade" id="confirm-approved" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                       <form id="approvedRequisition" action="${pageContext.request.contextPath}/staff/approvals/meeting/updatestatus" method="post">
                              <input type="hidden" id="meetingRequisitionId" name="meetingRequisitionId">
                                <input type="hidden" id="meetingApproverComment" name="meetingApproverComment">
                               <input type="hidden" id="meetingRequisitionStatus" name="meetingRequisitionStatus">
...
<script src="${pageContext.request.contextPath}/resources/themes/assets/pages/datatables.init.js"></script>
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/meetingapprovals.js" type="text/javascript"></script>
